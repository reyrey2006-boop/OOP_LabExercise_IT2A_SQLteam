...
public class DoneRequests extends JPanel {
    ...
    private static final String DONE_REQUESTS_VIEW = "DoneRequests"; // New View Constant
    ...
    // Data structure to hold request information (Copied from ApprovedRequests)
    ...
    // --- UI Components (createHeaderPanel and createNavigationPanel remain unchanged) ---
    ...
    private List<RequestData> fetchDoneRequestsFromDB() {
        ...
        // Query only for 'Done' update_status
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                requests.add(new RequestData(
                    ...
                    "", // unit placeholder (not needed for this view)
                    "", // description placeholder (not needed for this view)
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error loading Done Requests from DB: " + e.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
        }
        return requests;
    }
    ...
    // Navigation helper (copied from ApprovedRequests)
