...
public class ApprovedRequests extends JPanel {
    ...
    private ManageRequests manageRequestsPanel; 
    ...
    private static class RequestData {
        ...
        public RequestData(int requestId, String fullName, String email, String category, String unit, String description, String updateStatus, String dateSubmitted, String dateProcessed) {
    ...
    private void startAutoRefresh() {
        refreshTimer = new Timer(2000, e -> loadApprovedRequests()); 
        refreshTimer.start();
    }
    ...
    private JPanel createNavigationPanel() {
        ...
        gbc.insets = new Insets(0, 0, 15, 0); // Reset insets
    ...
    private JPanel createApprovedRequestsTablePanel() {
        ...
        manageButton.addActionListener(e -> {
            ...
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Please select a request from the table to manage.", "No Request Selected", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (details != null && targetPanel != null) {
                ...
                JOptionPane.showMessageDialog(this, "Could not load request details.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
    ...
    private RoundButton createStaffNavLink(String text, boolean isActive) {
        ...
        button.addActionListener(e -> {
            ...
            // Logic to prevent refresh if already on current view
    ...
    private RequestData fetchRequestDetailsById(int requestId) {
        String sql = "SELECT request_id, full_name, email_address, category, Location, description, update_status, date_submitted, date_processed FROM resident_requests WHERE request_id = ? AND status = 'Approved'";
