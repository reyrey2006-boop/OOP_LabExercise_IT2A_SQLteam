...
public class ResidentProfile extends JPanel{
    ...
    private JPanel createResidentProfileContentPanel() {
        ...
        editButton.addActionListener(e -> {
            // TODO: Implement logic to switch to an editable form or open a dialog
            JOptionPane.showMessageDialog(this, "Edit Profile functionality coming soon!", "Feature Note", JOptionPane.INFORMATION_MESSAGE);
        });
